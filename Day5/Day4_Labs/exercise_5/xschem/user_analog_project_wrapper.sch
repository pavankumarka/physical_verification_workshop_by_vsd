...
N 3570 -70 3830 -70 { lab=io_analog[4]}
N 3570 -10 3570 20 { lab=io_clamp_high[0]}
...
C {sky130_fd_pr/res_generic_m1.sym} 3570 -40 0 0 {name=R1
W=11
L=1.5
model=res_generic_m3
spiceprefix=X
mult=1}
C {devices/lab_pin.sym} 3570 20 0 0 {name=l13 sig_type=std_logic lab=io_clamp_high[0]}
